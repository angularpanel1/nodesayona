...
router.get('/allinoneappaaww', function (req, res, next) {
  async.waterfall([
    ...
    let sqlss = "INSERT INTO post_telegram3 (post_asin) VALUES ?";
  ...
  if (err) {
    ...
    if (err) {
      ...
      if(rides2.length > 0){ 
        ...
        console.log('rides2-88888-------: ', rides2[0].token);
            ...
            connection.query(sqlsss, function (err, flagData) {
              ...
              let ListflagData = flagData[0];
                ...
                let finalIdList = JSON.parse(ListflagData.array_data).user;
                 ...
                 if(req.body.teleSendFlag){ 
                //  for (let l = 0; l < finalPostList.length; l++) {
                    teleAutoPostChannel(finalAmazon,req.body.postImg,"@salebabaG",ListflagData.kudart_token);
                //  }
                }
                //  if(req.body.WattsSendFlag){ 
                //     whatsapp_posts3(finalAmazon,req.body.postImg,finalIdList[0].apiKey,finalIdList[0].phoneId,finalIdList[0].productId);
            ...
            connection.query(sqlsss, function (err, flagData) {
              ...
              let ListflagData = flagData[0];
                ...
                let finalIdList = JSON.parse(ListflagData.array_data).user;
                 ...
                 if(req.body.teleSendFlag){ 
                //  for (let l = 0; l < finalPostList.length; l++) {
                    teleAutoAudioPostChannel(finalAmazon,req.body.postImg,"@salebabaG",ListflagData.kudart_token);
                //  }
                }
                //  if(req.body.WattsSendFlag){ 
                //     whatsapp_posts3(finalAmazon,req.body.postImg,finalIdList[0].apiKey,finalIdList[0].phoneId,finalIdList[0].productId);
            ...
            connection.query(sqlsss, function (err, flagData) {
              ...
              let ListflagData = flagData[0];
                ...
                let finalIdList = JSON.parse(ListflagData.array_data).user;
                 ...
                 if(req.body.teleSendFlag){ 
                //  for (let l = 0; l < finalPostList.length; l++) {
                    teleAutoVideoPostChannel(finalAmazon,req.body.postImg,"@salebabaG",ListflagData.kudart_token);
                //  }
                }
                //  if(req.body.WattsSendFlag){ 
                //     whatsapp_posts3(finalAmazon,req.body.postImg,finalIdList[0].apiKey,finalIdList[0].phoneId,finalIdList[0].productId);
